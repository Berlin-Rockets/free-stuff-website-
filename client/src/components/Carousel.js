...
// console.log('items are:',items);
  ...
  <div className="col">
    <div className="card ">
      <img src= {require(`../../../images/${items[0].images[0]}`).default} className="d-block w-100" alt="pic2"/>
  ...
  <div className="col">
    <div className="card ">
    <img src={require(`../../../images/${items[1].images[0]}`).default} className="d-block w-100" alt="pic2"/>
      <div className="card-body">
  ...
  <div className="col">
    <div className="card ">
    <img src={require(`../../../images/${items[2].images[0]}`).default} className="d-block w-100" alt="pic2"/>
      <div className="card-body">
      ...
      <div className="card-footer">
        ...
        {items[2].createdAt}
          ...
          <div className="col">
            <div className="card ">
            <img src={require(`../../../images/${items[3].images[0]}`).default} className="d-block w-100" alt="pic2"/>
      <div className="card-body">
      ...
      <div className="card-footer">
        ...
        {items[3].createdAt}
          ...
          <div className="col">
            <div className="card ">
            <img src={require(`../../../images/${items[4].images[0]}`).default} className="d-block w-100" alt="pic2"/>
      <div className="card-body">
      ...
      <div className="card-footer">
        ...
        {items[4].createdAt}
          ...
          <div className="col">
            <div className="card ">
            <img src={require(`../../../images/${items[5].images[0]}`).default} className="d-block w-100" alt="pic2"/>
      <div className="card-body">
      ...
      <div className="card-footer">
        ...
        {items[5].createdAt}
          ...
          <div className="col">
            <div className="card ">
            <img src={require(`../../../images/${items[6].images[0]}`).default} className="d-block w-100" alt="pic2"/>
      <div className="card-body">
      ...
      <div className="card-footer">
        ...
        {items[6].createdAt}
          ...
          <div className="col">
            <div className="card ">
            <img src={require(`../../../images/${items[7].images[0]}`).default} className="d-block w-100" alt="pic2"/>
      <div className="card-body">
      ...
      <div className="card-footer">
        ...
        {items[7].createdAt}
          ...
          <div className="col">
            <div className="card ">
            <img src={require(`../../../images/${items[8].images[0]}`).default} className="d-block w-100" alt="pic2"/>
      <div className="card-body">
