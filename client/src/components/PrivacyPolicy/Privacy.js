...
const Privacy = () => {
  return (
    <div className="container">
      ...
      <p>
        Thank you for choosing to be part of our community at Freebay GmbH
      ...
      <p>
        ...
        <ul>
          <li>Visit our website at http://www.freebay.de</li>
          <li>
      ...
      <p>
        ...
        email addresses; usernames; passwords; contact or authentication data;
        contact preferences; and other similar information.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          contact us at __________ and be sure to include your name, testimonial
      ...
      <p>
        ...
        may be linked to or from the Website. You should review the policies of
